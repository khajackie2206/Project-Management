		...
		<>
			<InspectorControls>
				<PanelBody title={__("Settings", "basic-block")} initialOpen={true}>
					<PanelRow>
						<fieldset>
							<ToggleControl
								label={__("Show an heading before", "basic-block")}
								help={
									showHeading
										? __("Heading displayed", "basic-block")
										: __("No Heading displayed", "basic-block")
								}
								checked={showHeading}
					...
					{showHeading && (
						<>
							...
							<PanelRow>
								<fieldset>
									<SelectControl
										label={__("Select an icon", "basic-block")}
										value={iconName}
										...
										options={[
											...
											{
												value: "format-quote",
												label: __("Quote", "basic-block"),
											},
											{
												value: "info-outline",
												label: __("Info", "basic-block"),
											},
											{
												value: "warning",
												label: __("Warning", "basic-block"),
											},
										]}
									/>
								</fieldset>
			...
			<div {...blockProps}>
						...
						{iconName !== "none" && (
							<span
								className={classnames("dashicons", {
									[`dashicons-${iconName}`]: iconName !== "none",
								})}
							></span>
						)}
				...
				<RichText
					...
					placeholder={__("Enter the alert text...", "basic-block")}
