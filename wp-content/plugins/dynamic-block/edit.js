...
export default function Edit({ attributes, setAttributes }) {
	...
	return (
		<>
			<InspectorControls>
				<PanelBody title={__("Settings", "dynamic-block")} initialOpen={true}>
					<PanelRow>
						<fieldset>
							<ToggleControl
								label={__("Show a heading before", "dynamic-block")}
								help={
									showHeading
										? __("Heading displayed", "dynamic-block")
										: __("No Heading displayed", "dynamic-block")
								}
								checked={showHeading}
